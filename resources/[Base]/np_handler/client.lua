...
--local NearNPC = exports["np_handler"]:GetRandomNPC()
...
function isPed(checkType)
    ...
    if checkType == "countpolice" then
        pass = remoteCalls.execute("iciest :counts", "police")
    end

    if checkType == "countems" then
        pass = remoteCalls.execute("iciest :counts", "ems")
    end
...
-- local countpolice = exports["np_handler"]:isPed("femaleclothes")
...
RegisterNetEvent('np-fw:addedMoney')
AddEventHandler('np-fw:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('np-fw:addedCasino')
AddEventHandler('np-fw:addedCasino', function(blah,amount)
  casino = math.ceil(amount)
end)

RegisterNetEvent('np-fw:removedMoney')
AddEventHandler('np-fw:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
