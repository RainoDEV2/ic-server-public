        ...
        if curClosestNum ~= 0 and targetDoor ~= nil then
            ...
            if currentTargetDist < 2.0 then
                if isKeyDoor(curClosestNum) then
                    ...
                    exports['np-interaction']:showInteraction("["..Controlkey["generalUse"][2].."] " .. closestString .. ""  , color )
                        ...
                        if shortcheck > 2.2 and isKeyDoor(curClosestNum) then
                            ...
                            if targetDoor["lock"] == 0 then
                                ...
                                while active do
                                    ...
                                    exports['np-interaction']:showInteraction('Locking'  , 'error' )
                                ...
                                while active do
                                    Citizen.Wait(1)
                                    exports['np-interaction']:showInteraction('Unlocking')
            ...
            elseif currentTargetDist > 2.0 then
