...
exports["np-keymapping"]:registerKeyMapping("Switch Radio Channel", "Player", "Switch Radio Channel", "+radio", "-radio", "", true)

local radioChanel = 1

RegisterCommand("+radio", function(data, cb)
  if radioChanel >= 1 then
    radioChanel = radioChanel + 1
  end
  TriggerEvent('ChannelSet', radioChanel)
  TriggerEvent("DoLongHudText", "New Radio "..radioChanel)
end)
