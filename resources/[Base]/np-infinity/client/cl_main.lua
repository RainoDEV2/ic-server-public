...
TriggerServerEvent("iciest :infinity:player:ready")

RegisterNetEvent('iciest :infinity:player:coords')
AddEventHandler('iciest :infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('iciest :infinity:entity:coords')
AddEventHandler('iciest :infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('iciest :infinity:entity:coords', pNetId)
