...
RegisterNetEvent('iciest :paintball:gun')
AddEventHandler('iciest :paintball:gun', function()
  if not exports["np-inventory"]:hasEnoughOfItem("2285322324",1,false) then
...
RegisterNetEvent('iciest :paintball:ammo')
AddEventHandler('iciest :paintball:ammo', function()
...
function removeGuns()
  local qty = exports["np-inventory"]:getQuantity("2285322324")
