...
RegisterNetEvent("np_luckywheel:doRoll")
AddEventHandler("np_luckywheel:doRoll", function(_priceIndex)
    _isRolling = true
	SetEntityHeading(_wheel, 0.9754)
    Citizen.CreateThread(function()
        local speedIntCnt = 1
...
RegisterNetEvent("np_luckywheel:rollFinished")
AddEventHandler("np_luckywheel:rollFinished", function()
    _isRolling = false
end)
...
function doRoll()
    if not _isRolling then
        ...
        local lib, anim = _lib, 'enter_right_to_baseidle'
            ...
            TriggerServerEvent("np_luckywheel:getLucky")
...
-- end)
-- local enabled = true
RegisterNetEvent("np_luckywheel:spinit")
AddEventHandler("np_luckywheel:spinit", function()
    if not _isRolling  then
        doRoll()
...
RegisterNetEvent("attempt:change:spin", function()
	if exports['np_handler']:isPed("myjob") == "casino_dealer" then
