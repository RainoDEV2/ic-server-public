...
AddEventHandler("np-alerts:shoot",function(targetCoords)
    TriggerClientEvent('np-outlawalert:gunshotInProgress', -1, targetCoords)
	return
end)
...
RegisterServerEvent("np-alerts:boosting")
AddEventHandler("np-alerts:boosting",function(targetCoords, plate)
    TriggerClientEvent('np-alerts:boosting', -1, targetCoords, plate)
	return
end)
