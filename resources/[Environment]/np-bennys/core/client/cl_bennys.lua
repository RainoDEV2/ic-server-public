...
RegisterNetEvent('enter:benny:sandypd')
AddEventHandler('enter:benny:sandypd', function()
    local job = exports["np_handler"]:isPed("myJob")
	if (job == "police") then
...
--                 local rankCar = exports["np_handler"]:GroupRank("repairs_harmony")

--                 -- if not isPlyInBennys and nearDefault then
--                 --     exports["np-ui"]:showInteraction("Benny's")
...
Citizen.CreateThread(function()
    --FISHING
    exports["np-polyzone"]:AddBoxZone("benny1", vector3(-33.99, -1052.71, 28.4), 8.0, 11.6, {
        name="benny1",
        heading=305,
        --debugPoly=true,
        minZ=27.6,
    ...
    exports["np-polyzone"]:AddBoxZone("benny2", vector3(731.46, -1088.81, 22.17), 5.2, 11.2, {
        name="benny2",
        heading=359,
        --debugPoly=true,
        minZ=21.17,
    ...
    -- Chicken
    exports["np-polyzone"]:AddBoxZone("benny3", vector3(110.11, 6626.67, 31.84), 7.0, 7.4, {
        name="benny3",
        heading=315,
        --debugPoly=true,
        minZ=30.04,
    ...
    exports["np-polyzone"]:AddBoxZone("benny4", vector3(450.16, -975.93, 25.7), 10, 5, {
      ...
      exports["np-polyzone"]:AddBoxZone("benny5", vector3(1882.8, 3698.27, 33.54), 5.8, 3.2, {
        name="benny5",
        heading=30,
        --debugPoly=true,
        minZ=32.59,
...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "benny1" and IsPedInAnyVehicle(PlayerPedId()) and not isPlyInBennys then
        TriggerEvent('np-textui:ShowUI', 'show', ("%s"):format("Benny's"))
