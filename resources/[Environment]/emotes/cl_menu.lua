...
WarMenu.SetTitleColor("emotes", 0, 166, 231)
...
WarMenu.SetTitleColor("favorites", 0, 166, 231)
...
local function DrawMenu()
    if WarMenu.Button("Page:", selected_page.."/"..#p_anims, {r = 0, g = 166, b = 231, a = 150}) then ClearPedTasks(PlayerPedId()) playing_emote = false end
    if WarMenu.Button("Favorites", "Press F to favorite an emote", {r = 0, g = 166, b = 231, a = 150}) then WarMenu.OpenMenu("favorites") end
    local key = ""
    ...
    if WarMenu.Button("Cancel Emote",key, {r = 0, g = 166, b = 231, a = 150}) then ClearPedTasks(PlayerPedId()) playing_emote = false end
...
local function DrawFavorites()
    if WarMenu.Button("Cancel Emote", nil, {r = 0, g = 166, b = 231, a = 150}) then ClearPedTasks(PlayerPedId()) playing_emote = false end
    if WarMenu.MenuButton("Back", "emotes", {r = 0, g = 166, b = 231, a = 150}) then end
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened("emotes") then
            ...
            DrawText3Ds(plyCoords["x"],plyCoords["y"],plyCoords["z"]+0.5,"You can also type ~g~/e emotename~s~ in chat to perform them")
