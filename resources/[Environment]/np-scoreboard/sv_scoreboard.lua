...
IRP.Scoreboard = {}
IRP._Scoreboard = {}
IRP._Scoreboard.PlayersS = {}
IRP._Scoreboard.RecentS = {}
...
AddEventHandler("np-scoreboard:AddPlayer", function()
    ...
    IRP.Scoreboard.AddAllPlayers()
end)

function IRP.Scoreboard.AddAllPlayers(self)
...
function IRP.Scoreboard.AddPlayerS(self, data)
    IRP._Scoreboard.PlayersS[data.src] = data
end
