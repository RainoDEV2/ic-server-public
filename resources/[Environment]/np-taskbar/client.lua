...
function closeGui()
    ...
    ClearPedTasks(PlayerPedId())
    TriggerEvent("np-taskbar:disablecontrols", false)
end
...
function taskBar(length,name,runCheck,keepWeapon,vehicle,vehCheck)
    ...
    TriggerEvent("np-taskbar:disablecontrols", true)
...
RegisterNetEvent('np-taskbar:disablecontrols')
AddEventHandler('np-taskbar:disablecontrols', function(status)
    pDisabled = status
