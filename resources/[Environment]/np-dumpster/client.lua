            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished ==100) then
                        TriggerServerEvent('iciest :giveDumpsterReward')
                        TriggerServerEvent('iciest :startDumpsterTimer', dumpster)
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished ==100) then
                        TriggerServerEvent('iciest :giveDumpsterReward')
                        TriggerServerEvent('iciest :startDumpsterTimer', dumpster2)
                        FreezeEntityPosition(PlayerPedId(),false)
                        ClearPedTasks(PlayerPedId())
                    end
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished ==100) then
                        TriggerServerEvent('iciest :giveDumpsterReward')
                        TriggerServerEvent('iciest :startDumpsterTimer', dumpster3)
                        FreezeEntityPosition(PlayerPedId(),false)
                        ClearPedTasks(PlayerPedId())
                    end
...
RegisterNetEvent('iciest :removeDumpster')
AddEventHandler('iciest :removeDumpster', function(object)
    for i = 1, #searched do
