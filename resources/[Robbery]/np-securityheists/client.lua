    ...
    while pickup do
        ...
        if aDist < 10.0 then
            ...
            if aDist < 2.0 then
                ...
                DrawText3Ds(markerlocation["x"],markerlocation["y"],markerlocation["z"], "Press [~p~E~w~] to pick up cash.")
            else
       ...
       -- Citizen.Trace("Doing Animation")
        ...
        while pickingup do
            ...
            if IsEntityPlayingAnim(PlayerPedId(), "anim@mp_snowball", "pickup_snowball", 3) then
                ...
                TaskPlayAnim(PlayerPedId(), "anim@mp_snowball", "pickup_snowball", 8.0, -8, -1, 49, 0, 0, 0, 0)
            end 
