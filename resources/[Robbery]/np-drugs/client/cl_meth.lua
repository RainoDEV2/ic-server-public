...
-- 	if exports["np-inventory"]:hasEnoughOfItem("acetone",5,false) and exports["np-inventory"]:hasEnoughOfItem("sudafed",2,false) and exports["np-inventory"]:hasEnoughOfItem("antifreeze",3,false) and ongoing == false then
-- 		Cooking()
...
-- 	if exports["np-inventory"]:hasEnoughOfItem("methraw",5,false) and ongoing == false then
-- 		Packing()
-- 		FreezeEntityPosition(PlayerPedId(),true)
-- 		SetEntityHeading(PlayerPedId(), 359.97235107422)
-- 		local finished = exports["np-taskbar"]:taskBar(30000,"Breaking Meth!")
-- 		if (finished == 100) then
-- 			FreezeEntityPosition(PlayerPedId(),false)
...
-- 	if exports["np-inventory"]:hasEnoughOfItem("methbrick",2,false) and exports["np-inventory"]:hasEnoughOfItem("drugbaggy",1,false) and ongoing == false then
-- 		Scaling()
-- 		FreezeEntityPosition(PlayerPedId(),true)
-- 		SetEntityHeading(PlayerPedId(), 1.2570070028305)
-- 		local finished = exports["np-taskbar"]:taskBar(32000,"Packing Crystals!")
-- 		if (finished == 100) then
-- 			FreezeEntityPosition(PlayerPedId(),false)
